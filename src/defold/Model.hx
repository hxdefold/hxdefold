...
extern final class Model {
	...
	* */
	 ...
	 * @return AABB information with min and max as Vector3
	 **/
	@:pure
	@:native('get_aabb')
	static function getAabb(url:HashOrStringOrUrl):ModelAabb;
	 ...
	 * 
	 * @param url the model component
	 * @return table mapping mesh id hash -> AABB
	 **/
	@:pure
	@:native('get_mesh_aabb')
	static function getMeshAabb(url:HashOrStringOrUrl):lua.Table<Hash, ModelAabb>;
}
...
/** *
 * Axis-aligned bounding box data used by model.get_aabb and model.get_mesh_aabb.
 **/
typedef ModelAabb = {
